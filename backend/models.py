...
class InmuebleDB(Base):
    ...
    fecha_entrega = Column(String, nullable=True, index=True)
    avance_obra = Column(Integer, nullable=True)
    fase_obra = Column(String, nullable=True)
    subtipo_comercial = Column(String, nullable=True, index=True)
    dimensiones = Column(String, nullable=True)
    servicios_basicos = Column(String, nullable=True)
    datos_especificos_json = Column(Text, nullable=True)
